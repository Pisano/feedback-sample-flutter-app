...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    try {
      ...
      setState(() {
        _initialized = false;
        _initError = 'Pisano init failed.\n'
            'Error: $e\n'
            'Config: ${PisanoConfig.debugSummary()}\n'
            'Tip: Stop the app completely and re-run with --dart-define-from-file=pisano_defines.json';
      });
...
class _FeedbackFormScreenState extends State<FeedbackFormScreen> {
  ...
  Future<void> _onGetFeedbackPressed() async {
    ...
    final payload = <String, String>{
      'source': 'flutter_remote_sample_app',
    };
  ...
  Future<void> _onTrackPressed() async {
    ...
    final callback = await widget.feedbackSdk.track(
      ...
      payload: const {'source': 'flutter_remote_sample_app'},
      language: PisanoConfig.language,
    );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SegmentedButton<_TitleFont>(
                      segments: const [
                        ButtonSegment(
                            value: _TitleFont.title, label: Text('Title')),
                        ButtonSegment(
                            value: _TitleFont.body, label: Text('Body')),
                      ],
                      selected: {_titleFont},
                      onSelectionChanged: (s) =>
